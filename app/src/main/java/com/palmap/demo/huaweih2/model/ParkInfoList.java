...
public class ParkInfoList {
  ...
  public ParkInfoList() {
    ...
    ParkInfo P1 = new ParkInfo("粤B-22222", "H135", "P1", "￥10", "2h");
    ParkInfo P2 = new ParkInfo("粤B-33333", "H148", "P2", "￥20", "4h");
    ParkInfo P3 = new ParkInfo("粤B-44444", "H251", "P3", "￥50", "4h30min");
    ParkInfo P4 = new ParkInfo("粤B-55555", "H199", "P4", "￥50", "10h");
    ParkInfo P5 = new ParkInfo("粤B-66666", "H237", "P5", "￥53", "10h36min");
