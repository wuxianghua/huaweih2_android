...
//        list.add(getLayoutInflater().inflate(R.layout.welcome_tab3, null));
        ...
        list.add(createPager(R.drawable.welcome_tab1));
        list.add(createPager(R.drawable.welcome_tab2));
        list.add(createPager(R.drawable.welcome_tab3));
    ...
    private ImageView createPager(int resId) {
