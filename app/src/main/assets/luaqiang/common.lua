                ...
                Area = {
                    ...
                    renderer = {
                        ...
                        styles = {
                            ...
                            --商场
                            --[[
                             ['1300\\d{4}'] = Set3dColorWith('0xffb7c0ef', '0xff8a8aae','0xffb7c0ef','0xff8e9ad0',5.0),
                             --[[
                             [13001000] = Set3dColorWith('0xffb7c0ef', '0xff8a8aae','0xffb7c0ef','0xff8e9ad0',5.0),
                             [13007000] = Set3dColorWith('0xffb7c0ef', '0xff8a8aae','0xffb7c0ef','0xff8e9ad0',5.0),
                             [13002000] = Set3dColorWith('0xffb7c0ef', '0xff8a8aae','0xffb7c0ef','0xff8e9ad0',5.0),
                             [13003000] = Set3dColorWith('0xffb7c0ef', '0xff8a8aae','0xffb7c0ef','0xff8e9ad0',5.0),
                             [13004000] = Set3dColorWith('0xffb7c0ef', '0xff8a8aae','0xffb7c0ef','0xff8e9ad0',5.0),
                             --]]
                            ...
                            --[[
                             --餐饮服务 count = 53
                             ['11\\d{6}'] =
                             Set3dColorWith('0xfff7e9d5', '0xff8a8aae','0xfff7e9d5','0xfff9dcb3',5.0),
                             
                             --商业店铺1 count = 18
                             ['1300\\d{4}|130[123]\\d{4}'] = Set3dColorWith('0xffb7c0ef','0xff8a8aae','0xffb7c0ef','0xffa1adec',5.0),
                             
                             --商业店铺2 count = 60
                             ['130[5-9]\\d{4}|131\\d{5}'] = Set3dColorWith('0xffa5b1f2','0xff8a8aae','0xffa5b1f2','0xff8d9be8',5.0),
                             
                             --生活服务  count = 76
                             ['(12|14|15)\\d{6}'] =
                             Set3dColorWith('0xffb9cbf9', '0xff8a8aae','0xffb9cbf9','0xff9faaf9',5.0),
                             
                             --医疗相关 count = 16
                             ['16\\d{6}'] =
                             Set3dColorWith('0xff92c4ff', '0xff8a8aae','0xff92c4ff','0xff9ab5fb',5.0),
                             
                             --医疗科室1 count = 18 //2104[2-9]\d{3} //21023\d{3} //2100[1-9]\d{3} //2105[1-9]\d{3}
                             ['(2104[2-9]| 21023|2100[1-9]|2105[1-9])\\d{3}'] =
                             Set3dColorWith('0xff92c4ff', '0xff8a8aae','0xff92c4ff','0xff9ab5fb',5.0),
                             
                             --医疗科室2 count = 31 //2101\d{4} //2102[^3]\d{3}  //2103\d{4}  //2104[01]\d{3}
                             ['(2101[0-9]|2102[^3]|2103[0-9]|2104[01])\\d{3}'] =
                             Set3dColorWith('0xffd4edff', '0xff8a8aae','0xffd4edff','0xffd4e2ff',5.0),
                             
                             --交通设施 count = 8
                             ['17\\d{6}'] =
                             Set3dColorWith('0xffffcaa6', '0xff8a8aae','0xffffcaa6','0xfff9bc92',5.0),
                             
                             --交通服务1 count =13   //2200[^5]\d{3}  //2201[89]\d{3}  //2202[0]\d{3} //2203[129]\d{3}
                             -- //2204[0]\d{3} //2205[1]\d{3}
                             ['(2200[^5]|2201[89]|2202[0]|2203[129]|2204[0]|2205[1])\\d{3}'] =
                             Set3dColorWith('0xffffcaa6', '0xff8a8aae','0xffffcaa6','0xfff9bc92',5.0),
                             
                             --交通服务2 count = 21  //2201[^89]\d{3} //2200[5]\d{3}  //2202[^0]\d{3} //2203[^129]\d{3}
                             --2205[^1]\d{3}
                             ['(2201[^89]|2200[5]|2202[^0]|2203[^129]|2205[^1])\\d{3}'] =
                             Set3dColorWith('0xfffdebd8', '0xff8a8aae','0xfffdebd8','0xfffedebc',5.0),
                             
                             --一般性功能区域 count = 62
                             ['23\\d{6}'] =
                             Set3dColorWith('0xffe0ffcc', '0xff8a8aae','0xffe0ffcc','0xffd3f8bc',5.0),
